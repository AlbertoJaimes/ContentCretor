				...
				return (
					s.each(e.match(w), function (e, t) {
						s.expr.match.bool.test(t) &&
							...
							n &&
								(u('removeAttr-bool', 'jQuery.fn.removeAttr no longer sets boolean properties: ' + t), r.prop(t, !1));
					}),
			...
			function (e, t, r) {
				...
				if (t && 'object' == typeof t && 2 === arguments.length) {
					for (a in ((n = s.hasData(e) && E.call(this, e)), (o = {}), t))
						a !== x(a)
							? (u('data-camelCase', 'jQuery.data() always sets/gets camelCased names: ' + a), (n[a] = t[a]))
							: (o[a] = t[a]);
				...
				i(
					...
					function () {
						1 < s.easing[this.easing].length &&
							(u('easing-one-arg', "'jQuery.easing." + this.easing.toString() + "' should use only one argument"),
				...
				i(
					...
					function (e, t) {
						...
						return (
							void 0 === t &&
								r &&
								(u('param-ajax-traditional', 'jQuery.param() no longer uses jQuery.ajaxSettings.traditional'), (t = r)),
							D.call(this, e, t)
						);
					},
